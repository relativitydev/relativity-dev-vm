...
[string] $global:testSingleRelativityVersion = "10.3.781.4" # Leave it blank when in Automated Production mode
[string] $global:invariantVersion = "5.3.282.2" # Leave it blank when in Automated Production mode
[string] $global:releaseName = "Goatsbeard 3 - Service Pack 1" # Make sure to update this to the correct release name for the Relativity Version above, leave it blank when in Automated Production mode
