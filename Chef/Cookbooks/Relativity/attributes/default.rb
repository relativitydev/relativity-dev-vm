...
default['sql']['installer_iso_file_name'] = 'Sql.iso'
default['sql']['installer_iso_file_original_location'] = '\\\\kcura.corp\\shares\\Development\\DevEx\\Install_Files\\SQL_Server_Dev_Edition'
default['sql']['installer_iso_file_destination_location'] = 'C:\\Chef_Install\\Sql'
