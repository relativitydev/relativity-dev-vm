...
default['software']['jungum']['source'] = "#{ENV['devvm_installer_files_path']}\\Jungum\\#{default['software']['jungum']['file_name']}"
...
default['software']['lotus_notes']['source'] = "#{ENV['devvm_installer_files_path']}\\LotusNotes\\#{default['software']['lotus_notes']['file_name']}"
...
default['software']['MSOffice']['source'] = "#{ENV['devvm_installer_files_path']}\\MSOffice\\#{default['software']['MSOffice']['file_name']}"
...
default['software']['MSWorksConverter']['source'] = "#{ENV['devvm_installer_files_path']}\\MSWorksConverter\\#{default['software']['MSWorksConverter']['file_name']}"
...
default['software']['elastic_search']['source'] = "#{ENV['devvm_installer_files_path']}\\ElasticSearch\\#{default['software']['elastic_search']['file_name']}"
...
default['sql']['install']['source_folder'] = "#{ENV['devvm_installer_files_path']}\\SQL_Server_2016_Developer_Edition"
...
default['service_bus']['defect_windows_update']['install']['source_folder'] = "#{ENV['devvm_installer_files_path']}\\Service_Bus_Defect_Windows_Update"
...
default['secret_store']['install']['source_folder'] = "#{ENV['devvm_installer_files_path']}\\SecretStore"
...
default['relativity']['install']['source_folder'] = "#{ENV['devvm_installer_files_path']}\\Relativity"
...
default['invariant']['install']['source_folder'] = "#{ENV['devvm_installer_files_path']}\\Invariant"
