...
{
	[Cmdlet(VerbsCommon.Add, "ProcessingAddWorkerServerToDefaultResourcePool")]
	public class ProcessingAddWorkerServerToDefaultResourcePoolModule : BaseModule
	{
		[Parameter(
			Mandatory = true,
		...
		protected override void ProcessRecordCode()
		{
			...
			processingHelper.AddWorkerServerToDefaultResourcePool();
		}
