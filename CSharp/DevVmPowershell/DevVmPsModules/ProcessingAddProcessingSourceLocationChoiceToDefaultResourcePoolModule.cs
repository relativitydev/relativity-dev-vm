...
{
	[Cmdlet(VerbsCommon.Add, "ProcessingSourceLocationChoiceToDefaultResourcePool")]
	public class ProcessingAddProcessingSourceLocationChoiceToDefaultResourcePoolModule : BaseModule
	{
		[Parameter(
			Mandatory = true,
		...
		protected override void ProcessRecordCode()
		{
			...
			processingHelper.AddProcessingSourceLocationChoiceToDefaultResourcePool();
		}
