...
{
	[Cmdlet(VerbsCommon.Add, "ProcessingAddAgentServerToDefaultResourcePool")]
	public class ProcessingAddAgentServerToDefaultResourcePoolModule : BaseModule
	{
		[Parameter(
			Mandatory = true,
		...
		protected override void ProcessRecordCode()
		{
			...
			processingHelper.AddAgentServerToDefaultResourcePool();
		}
